...
def deploy_stack(model_selection: str) -> None:
    """
    ...
    try:
        ...
        subprocess.run(f"cdk deploy --require-approval never", shell=True, check=True)
...
def get_deployment_confirmation(model_info: Dict[str, str]) -> bool:
    """
