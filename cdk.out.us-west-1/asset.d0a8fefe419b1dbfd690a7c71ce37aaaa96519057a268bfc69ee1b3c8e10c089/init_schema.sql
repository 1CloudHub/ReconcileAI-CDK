...
CREATE SEQUENCE IF NOT EXISTS erp_no_sap.sop_exception_seq
    INCREMENT BY 1
    MINVALUE 1
    MAXVALUE 99999
    START 1
...
ALTER SEQUENCE erp_no_sap.sop_exception_seq OWNER TO postgres;
GRANT ALL ON SEQUENCE erp_no_sap.sop_exception_seq TO postgres;
